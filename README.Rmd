...
See the published articles (Brassard et al., Appl Physiol Nutr Metab 2021) for details regarding the development and the evaluation of the HEFI-2019, as well as information on classification of foods. Of note, when no foods, beverages or energy is reported, ratios are not calculated and a score of 0 is assigned to the corresponding components.
...
mydata_scored <- hefi2019(indata         = mydata,
                         ...
                         unsweetmilk     = milk,
                         unsweetplantbevpro = 0, # 0 = if food was not consumed
                         otherbev        = otherbev ,
                         mufat           = mufa ,
                         pufat           = pufa ,
                         satfat          = sfa ,
