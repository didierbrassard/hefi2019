...
mydata <-
  read_sas(paste0(path,"/scoreacutevf.sas7bdat")) %>%
  # rename variables for clarity
  dplyr::rename(
                RA_vegfruits      = RA_qty_vegwfruit,
                RA_wholegrfoods   = RA_qty_grfoodswhole,
                RA_nonwgfoods     = RA_qty_grfoodsrefined,
                RA_profoodsanimal = RA_qty_profoodsanimal,
                RA_profoodsplant  = RA_qty_profoodsplant,
                RA_otherfoods     = RA_qty_other,
                G_otherbeverages  = FID_WTG_otherbev,
                G_waterhealthybev = water_and_other_healthy,
                G_milk            = milk,
                G_plantbevpro     = FID_WTG_proplantbev,
                G_mufa            = mufa,
                G_pufa            = pufa,
                G_sfa             = sfa,
                G_freesugars      = sugfree,
                MG_sodium         = sodium
                )
