...
/* Calculate the Healthy Eating Food Index total score (i.e., the sum of its component scores) */
         HEFI2019_TOTAL_SCORE = HEFI2019C1_VF + HEFI2019C2_WHOLEGR + HEFI2019C3_GRRATIO + HEFI2019C4_PROFOODS + HEFI2019C5_PLANTPRO + HEFI2019C6_BEVERAGES + HEFI2019C7_FATTYACID + HEFI2019C8_SFAT + HEFI2019C9_SUGARS + HEFI2019C10_SODIUM ; 
